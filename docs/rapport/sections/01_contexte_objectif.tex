% 01 - CONTEXTE
% ==============================================================
\sectionintro{01 · Démarche}{Contexte et objectif}{Conserver la trace de la première approche, puis présenter la version finale structurée et validée sous TwinCAT.}
...
\begin{minipage}[t]{0.355\textwidth}\vspace{0pt}
  ...
  \small
  Le document distingue la \textbf{solution de principe montrée pendant l'entretien} de la \textbf{version finale approfondie, compilée, exécutée et validée sur le runtime local}. Le fichier source joint correspond à cette version finale ; les fonctions non réalisées restent identifiées comme évolutions.
  ...
  \begin{enumerate}\small
    ...
    \item corriger puis rejouer les essais.
  \end{enumerate}
\end{minipage}\hfill
\begin{minipage}[t]{0.605\textwidth}\vspace{0pt}
  ...
  \begin{notebox}{Ce qui a changé ensuite}
    La reprise sous TwinCAT remplace cette séquence linéaire par deux niveaux : un mode global \texttt{INIT / AUTO / DEFAUT}, puis une machine d'états dédiée au cycle \texttt{AUTO}.
  \end{notebox}
