...
\end{lstlisting}
  ...
  \end{primarycard}
  \begin{notebox}{Effet individuel}
    Dès qu'un bouton \texttt{aResetBac[i]} est vrai, le compteur du bac \texttt{i} est maintenu à zéro. Si le bouton reste vrai pendant 10 s, le même signal déclenche ensuite la remise à zéro globale.
  \end{notebox}
\end{minipage}\hfill
