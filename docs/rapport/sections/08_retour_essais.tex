% 08 - CAS LIMITES
% ==============================================================
\sectionintro{08 · Retour d'essais}{Cas limites détectés et corrigés}{Les essais sur le runtime local ont fait apparaître des comportements absents du cycle nominal.}
...
\begin{primarycard}
  ...
  Les essais ont couvert le cycle nominal, les valeurs limites et la saturation des huit bacs. Chaque correction a ensuite été rejouée sur le runtime local.
\end{primarycard}
