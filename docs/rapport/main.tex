...
% Version 2.0 : implementation et validation TwinCAT 3
...
\hypersetup{
  ...
  pdfsubject={Logique de carrousel implementee et testee sous TwinCAT 3},
  pdfkeywords={TQS, TwinCAT 3, Structured Text, machine d'etats, automatisme, validation, carrousel}
}
...
\fancyhead[R]{\headerlower{\footnotesize\color{ekmuted}TQS · 04.09.2026}}
