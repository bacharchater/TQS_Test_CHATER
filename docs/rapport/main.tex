...
% Version 2.2 : rapport PLC et annexe IHM hors perimetre initial
...
\hypersetup{
  ...
  pdfsubject={Rapport technique PLC avec annexe consacree aux IHM realisees apres l'entretien},
  pdfkeywords={TQS, TwinCAT 3, Structured Text, machine d'etats, automatisme, PLC Visualization, TwinCAT HMI, carrousel}
}
...
\fancyhead[C]{\headerlower{\footnotesize\color{ekmuted}Conception \& validation · Carrousel de conditionnement}}
...
% CONTENU DU RAPPORT
% ==============================================================
\input{sections/00_couverture}
\input{sections/00_sommaire}
\input{sections/01_contexte_objectif}
\input{sections/02_systeme_perimetre}
\input{sections/03_architecture_twincat}
\input{sections/04_sequencement}
\input{sections/05_structured_text}
\input{sections/06_robustesse}
\input{sections/07_essais_twincat}
\input{sections/08_retour_essais}
\input{sections/09_limites_evolutions}
\input{sections/10_conclusion}
\input{sections/annexe_a_types_interface}
\input{sections/annexe_b_ihm}
