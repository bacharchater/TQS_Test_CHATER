...
EventProvider.register(
    ...
    (e) => {
        ...
        const host =
            TcHmi.Controls.get('DashboardHost');


        if (!host) {
            console.error(
                'DashboardHost introuvable',
            );
            return;
        }
        ...
        const element =
            host.getElement()[0] as HTMLElement;
