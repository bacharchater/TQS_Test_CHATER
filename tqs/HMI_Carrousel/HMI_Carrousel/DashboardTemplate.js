...
export class DashboardTemplate {
    ...
    /* ============================================================
       ...
       ============================================================ */
    render() {
        const bacsHtml = this.createBacsHtml();
        return ('<div class="tqs-dashboard">' +
            /* =================================================
               HEADER
               ================================================= */
            ...
            '</div>' +
            /* ---------- Vérin avant ---------- */
            this.createStatusRow('Vérin avant', 'cylinderForwardLed', 'cylinderForwardValue') +
            /* ---------- Vérin arrière ---------- */
            this.createStatusRow('Vérin arrière', 'cylinderBackwardLed', 'cylinderBackwardValue') +
            /* ---------- Cycle vérin ---------- */
    ...
    /* ============================================================
       ...
       ============================================================ */
    createStatusRow(label, ledId, valueId) {
        return ('<div class="tqs-status-row">' +
            '<span class="tqs-status-row__label">' +
            label +
            '</span>' +
            '<span class="tqs-status-row__state">' +
